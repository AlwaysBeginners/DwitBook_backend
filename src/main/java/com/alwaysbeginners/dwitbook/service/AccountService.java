package com.alwaysbeginners.dwitbook.service;

import com.alwaysbeginners.dwitbook.domain.account.Account;
import com.alwaysbeginners.dwitbook.domain.account.AccountRepository;
import com.alwaysbeginners.dwitbook.dto.account.AccountDto.SignUpReq;
...
public class AccountService implements UserDetailsService {
    ...
    public Account signUp(SignUpReq dto) {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        return accountRepository.findAccountByEmailEquals(username)
